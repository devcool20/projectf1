        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ marginBottom: 12 }}>
            <View style={{ flexDirection: 'row', alignItems: 'flex-start', flexWrap: 'wrap', marginBottom: 4 }}>
              <Text style={{ fontWeight: 'bold', color: '#000', fontSize: 15, marginTop: 8 }}>
                {reply.threads?.profiles?.username || 'Unknown User'}
              </Text>
              {threadLogo && (
                <Image 
                  source={threadLogo} 
                  style={{ width: 24, height: 22, marginLeft: 4, marginTop: 8 }}
                  resizeMode="contain"
                />
              )}
              <Text style={{ fontSize: 11, color: '#888', marginLeft: 8, marginTop: 8 }}>
